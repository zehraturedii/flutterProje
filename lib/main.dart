...
import 'package:fiesta/Helpers/handle_native.dart';
import 'package:fiesta/Helpers/logging.dart';
...
import 'package:fiesta/constants/constants.dart';
import 'package:fiesta/constants/languagecodes.dart';
import 'package:fiesta/providers/audio_service_provider.dart';
import 'package:fiesta/theme/app_theme.dart';
...
Future<void> main() async {
  ...
  if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
    await Hive.initFlutter('fiesta/Database');
...
Future<void> openHiveBox(String boxName, {bool limit = false}) async {
  final box = await Hive.openBox(boxName).onError((error, stackTrace) async {
    ...
    if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
      dbFile = File('$dirPath/fiesta/$boxName.hive');
      lockFile = File('$dirPath/fiesta/$boxName.lock');
    }
    await dbFile.delete();
...
Future<void> backgroundCallback(Uri? data) async {
  if (data?.host == 'controls') {
    ...
    // );
    // await HomeWidget.updateWidget(name: 'fiestaMusicWidget');
  }
}
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    HomeWidget.setAppGroupId('com.shadow.fiesta');
